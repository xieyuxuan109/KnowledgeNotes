...
type HelloRequest struct {
	...
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"` //请求消息中的字段，类型为string，字段编号为1
...
type HelloResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Reply         string                 `protobuf:"bytes,1,opt,name=reply,proto3" json:"reply,omitempty"` //请求消息中的字段，类型为string，字段编号为1
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_hello_proto_rawDesc = "" +
	...
	"\x05reply\x18\x01 \x01(\tR\x05reply2\x88\x01\n" +
	"\aGreeter\x12E\n" +
	"\bSayHello\x12\x10.pb.HelloRequest\x1a\x11.pb.HelloResponse\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/hello\x126\n" +
	"\rLotsOfReplies\x12\x10.pb.HelloRequest\x1a\x11.pb.HelloResponse0\x01B\x11Z\x0fhello_server/pbb\x06proto3"
